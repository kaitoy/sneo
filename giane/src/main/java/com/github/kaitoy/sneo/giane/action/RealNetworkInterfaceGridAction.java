...
import com.github.kaitoy.sneo.giane.model.dto.RealNetworkInterfaceDto;
import com.opensymphony.xwork2.ActionContext;
import com.opensymphony.xwork2.ActionSupport;

@ParentPackage("giane-default")
@InterceptorRef("gianeDefaultStack")
public class RealNetworkInterfaceGridAction extends ActionSupport {
  ...
  private static final Comparator<RealNetworkInterfaceDto> idComparator
    = new Comparator<RealNetworkInterfaceDto>() {
        public int compare(RealNetworkInterfaceDto o1, RealNetworkInterfaceDto o2) {
          return o2.getId().compareTo(o1.getId());
        }
      };
  private static final Comparator<RealNetworkInterfaceDto> nameComparator
    = new Comparator<RealNetworkInterfaceDto>() {
        public int compare(RealNetworkInterfaceDto o1, RealNetworkInterfaceDto o2) {
  ...
  // result List
  private List<RealNetworkInterfaceDto> gridModel;
  ...
  public String execute() {
    ...
    gridModel = new ArrayList<RealNetworkInterfaceDto>();
    List<RealNetworkInterface> nifs
      = realNetworkInterfaceDao.findByCriteria(criteria);
    for (RealNetworkInterface nif: nifs) {
      gridModel.add(new RealNetworkInterfaceDto(nif));
    }
  ...
  public List<RealNetworkInterfaceDto> getGridModel() {
    return gridModel;
  }

  public void setGridModel(List<RealNetworkInterfaceDto> gridModel) {
