...
public class LagUnassociatedPhysicalNetworkInterfaceGridAction extends ActionSupport {

  /**
   *
   */
  private static final long serialVersionUID = -3783173697281494200L;
  ...
  public String execute() {
    ...
    predicates.add(cb.or(cb.isNull(r.get("lag")), cb.notEqual(r.get("lag"), lag_id))) ;
