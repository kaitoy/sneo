  ...
  public String execute() {
    ...
    if (searchField != null) {
      if (searchField.equals("id") || searchField.equals("port")) {
        ...
        if (searchOper.equals("eq")) {
          predicates.add(cb.equal(r.get(searchField), FileMibFormat.valueOf(searchString)));
        }
        else if (searchOper.equals("ne")) {
          predicates.add(cb.notEqual(r.get(searchField), FileMibFormat.valueOf(searchString)));
        }
      }
    }
