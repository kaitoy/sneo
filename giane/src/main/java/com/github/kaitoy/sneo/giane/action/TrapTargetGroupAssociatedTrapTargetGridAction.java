...
public class TrapTargetGroupAssociatedTrapTargetGridAction extends ActionSupport {
  ...
  public String execute() {
    ...
    List<TrapTarget> models
      = trapTargetDao
          .findByCriteriaAndTrapTargetGroupId(criteria, trapTargetGroup_id, true);

    gridModel = new ArrayList<TrapTargetDto>();
    for (TrapTarget tt: models) {
      gridModel.add(new TrapTargetDto(tt));
    }
