...
public class AdditionalIpV6RouteGroupAssociatedAdditionalIpV6RouteGridAction extends ActionSupport {

  /**
   *
   */
  private static final long serialVersionUID = 80258854671638653L;
  ...
  public String execute() {
    ...
    List<AdditionalIpV6Route> models
      = additionalIpV6RouteDao
          .findByCriteriaAndAdditionalIpV6RouteGroupId(cq, additionalIpV6RouteGroup_id, true);

    gridModel = new ArrayList<AdditionalIpV6RouteDto>();
    for (AdditionalIpV6Route tt: models) {
      gridModel.add(new AdditionalIpV6RouteDto(tt));
    }
