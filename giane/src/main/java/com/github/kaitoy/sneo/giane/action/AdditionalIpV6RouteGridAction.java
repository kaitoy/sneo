...
public class AdditionalIpV6RouteGridAction extends ActionSupport {

  /**
   *
   */
  private static final long serialVersionUID = -5650560672148415379L;

  private static final Map<String, Comparator<AdditionalIpV6RouteDto>> comparators
    = new HashMap<String, Comparator<AdditionalIpV6RouteDto>>();
  ...
  public String execute() {
    ...
    List<AdditionalIpV6Route> models = additionalIpV6RouteDao.findByCriteria(cq);
    gridModel = new ArrayList<AdditionalIpV6RouteDto>();
    for (AdditionalIpV6Route entry: models) {
      gridModel.add(new AdditionalIpV6RouteDto(entry));
    }
