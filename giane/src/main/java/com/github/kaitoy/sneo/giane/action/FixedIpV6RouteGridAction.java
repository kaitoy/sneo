...
import com.github.kaitoy.sneo.giane.model.dto.IpV6RouteDto;
import com.opensymphony.xwork2.ActionContext;
import com.opensymphony.xwork2.ActionSupport;

@ParentPackage("giane-default")
@InterceptorRef("gianeDefaultStack")
public class FixedIpV6RouteGridAction extends ActionSupport {

  /**
   *
   */
  private static final long serialVersionUID = -639915623498952756L;

  private static final Map<String, Comparator<IpV6RouteDto>> comparators
    = new HashMap<String, Comparator<IpV6RouteDto>>();

  static  {
    comparators.put(
      "id",
      new Comparator<IpV6RouteDto>() {
        public int compare(IpV6RouteDto o1, IpV6RouteDto o2) {
  ...
  // result List
  private List<IpV6RouteDto> gridModel;
  ...
  public String execute() {
    CriteriaBuilder cb = fixedIpV6RouteDao.getCriteriaBuilder();
    CriteriaQuery<FixedIpV6Route> cq = cb.createQuery(FixedIpV6Route.class);
    Root<FixedIpV6Route> r = cq.from(FixedIpV6Route.class);
    cq.select(r);
    ...
    List<FixedIpV6Route> models = fixedIpV6RouteDao.findByCriteria(cq);
    gridModel = new ArrayList<IpV6RouteDto>();
    for (FixedIpV6Route entry: models) {
      gridModel.add(new IpV6RouteDto(entry));
    }
  ...
  public List<IpV6RouteDto> getGridModel() {
    return gridModel;
  }

  public void setGridModel(List<IpV6RouteDto> gridModel) {
