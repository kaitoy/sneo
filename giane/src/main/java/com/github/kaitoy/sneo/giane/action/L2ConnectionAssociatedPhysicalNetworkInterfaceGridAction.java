...
public class L2ConnectionAssociatedPhysicalNetworkInterfaceGridAction extends ActionSupport {
  ...
  public String execute() {
    ...
    Integer l2Connection_id
      = Integer.valueOf(((String[])params.get("l2Connection_id"))[0]);
    criteria.add(Restrictions.eq("l2Connection.id", l2Connection_id));
    ...
    if (searchField != null) {
      ...
      else if (searchField.equals("name") || searchField.equals("nodeName")) {
    ...
    if (sord != null) {
      ...
      else if (sidx.equalsIgnoreCase("nodeName")) {
