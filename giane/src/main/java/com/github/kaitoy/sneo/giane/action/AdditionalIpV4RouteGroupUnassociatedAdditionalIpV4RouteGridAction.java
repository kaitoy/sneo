...
public class AdditionalIpV4RouteGroupUnassociatedAdditionalIpV4RouteGridAction extends ActionSupport {

  /**
   *
   */
  private static final long serialVersionUID = 4467903454376471389L;
  ...
  private static final Comparator<AdditionalIpV4RouteDto> idComparator
    = new Comparator<AdditionalIpV4RouteDto>() {
        public int compare(AdditionalIpV4RouteDto o1, AdditionalIpV4RouteDto o2) {
          return o2.getId().compareTo(o1.getId());
        }
      };
  private static final Comparator<AdditionalIpV4RouteDto> nameComparator
    = new Comparator<AdditionalIpV4RouteDto>() {
        public int compare(AdditionalIpV4RouteDto o1, AdditionalIpV4RouteDto o2) {
  ...
  public String execute() {
    ...
    Integer additionalIpV4RouteGroup_id
      = Integer.valueOf(((String[])params.get("additionalIpV4RouteGroup_id"))[0]);
    List<AdditionalIpV4Route> models
      = additionalIpV4RouteDao
          .findByCriteriaAndAdditionalIpV4RouteGroupId(cq, additionalIpV4RouteGroup_id, false);

    gridModel = new ArrayList<AdditionalIpV4RouteDto>();
    for (AdditionalIpV4Route additionalIpV4Route: models) {
      gridModel.add(new AdditionalIpV4RouteDto(additionalIpV4Route));
    }
