...
<sj:tabbedpanel id="vlan_config_tabs" animate="true" cssClass="giane-tab-container" selectedTab="%{selectedTab}">
  ...
  <sj:div id="associate_vlan_with_vlanMembers_tab_content" href="%{associate_vlan_with_vlanMembers_tab_content_url}" indicator="associate_vlan_with_vlanMembers_tab_indicator" cssClass="giane-tab-content clearfix" />
