...
<sj:tabbedpanel id="configHome_tabs" animate="true" cssClass="giane-tab-container" selectedTab="%{selectedTab}">
  ...
  <sj:div id="network_tab_content" href="%{network_tab_content_url}" indicator="network_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="realNetworkInterfaceConfiguration_tab_content" href="%{realNetworkInterfaceConfiguration_tab_content_url}" indicator="realNetworkInterfaceConfiguration_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="additionalIpV4Route_tab_content" href="%{additionalIpV4Route_tab_content_url}" indicator="additionalIpV4Route_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="additionalIpV4RouteGroup_tab_content" href="%{additionalIpV4RouteGroup_tab_content_url}" indicator="additionalIpV4RouteGroup_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="trapTarget_tab_content" href="%{trapTarget_tab_content_url}" indicator="trapTarget_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="trapTargetGroup_tab_content" href="%{trapTargetGroup_tab_content_url}" indicator="trapTargetGroup_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="simulation_tab_content" href="%{simulation_tab_content_url}" indicator="simulation_tab_indicator" cssClass="giane-tab-content clearfix" />
</sj:tabbedpanel>
