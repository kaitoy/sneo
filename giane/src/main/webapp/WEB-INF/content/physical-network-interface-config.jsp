...
<div id="breadcrumbs">
  ...
  <s:url var="node_url" action="back-to-node-config" escapeAmp="false">
    <s:param name="network_id" value="%{#parameters.network_id}" />
    <s:param name="network_name" value="%{#parameters.network_name}" />
  ...
  &nbsp;&gt;&nbsp;[<s:text name="breadcrumbs.physicalNetworkInterface.configuration" />: <s:property value="#parameters.physicalNetworkInterface_name" />]
</div>

<sj:tabbedpanel id="physicalNetworkInterface_config_tabs" animate="true" cssClass="tabs">
