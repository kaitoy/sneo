...
<sj:tabbedpanel id="simulation_tabs" animate="true" cssClass="giane-tab-container" selectedTab="%{selectedTab}">
  ...
  <sj:div id="set_trapTargetGroup_to_snmpAgent_tab_content" href="%{set_trapTargetGroup_to_snmpAgent_tab_content_url}" indicator="set_trapTargetGroup_to_snmpAgent_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="set_realNetworkInterfaceConfiguration_to_realNetworkInterface_tab_content" href="%{set_realNetworkInterfaceConfiguration_to_realNetworkInterface_tab_content_url}" indicator="set_realNetworkInterfaceConfiguration_to_realNetworkInterface_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="set_additionalIpV4RouteGroup_to_node_tab_content" href="%{set_additionalIpV4RouteGroup_to_node_tab_content_url}" indicator="set_additionalIpV4RouteGroup_to_node_tab_indicator" cssClass="giane-tab-content clearfix" />
</sj:tabbedpanel>
