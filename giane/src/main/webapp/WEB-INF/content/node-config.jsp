...
<sj:tabbedpanel id="node_config_tabs" animate="true" cssClass="giane-tab-container" selectedTab="%{selectedTab}">
  ...
  <sj:div id="snmpAgent_tab_content" href="%{snmpAgent_tab_content_url}" indicator="snmpAgent_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="physicalNetworkInterface_tab_content" href="%{physicalNetworkInterface_tab_content_url}" indicator="physicalNetworkInterface_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="realNetworkInterface_tab_content" href="%{realNetworkInterface_tab_content_url}" indicator="realNetworkInterface_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="vlan_tab_content" href="%{vlan_tab_content_url}" indicator="vlan_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="lag_tab_content" href="%{lag_tab_content_url}" indicator="lag_tab_indicator" cssClass="giane-tab-content clearfix" />
  ...
  <sj:div id="fixedIpV4Route_tab_content" href="%{fixedIpV4Route_tab_content_url}" indicator="fixedIpV4Route_tab_indicator" cssClass="giane-tab-content clearfix" />
</sj:tabbedpanel>
